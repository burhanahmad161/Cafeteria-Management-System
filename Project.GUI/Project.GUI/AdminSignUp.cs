    ...
    public partial class AdminSignUp : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (n >= 8)
            {
                ...
                {
                    bool flag = AdminLoginBL.isvalidAdmin(textBox1.Text);
                    if (flag == true)
                    {
                        AdminLoginBL obj = new AdminLoginBL(textBox3.Text, textBox1.Text, textBox2.Text);
                        AdminLoginDL.addIntoFile(obj);
                        AdminLoginDL.addIntoList(obj);
                        MessageBox.Show("Successfully Signed Up");
                        AdminLoginDL.loadAdminData();
                        AdminFuctionalities abc = new AdminFuctionalities();
                        abc.Show();
                    }
                    else
                    {
                ...
                {
                    MessageBox.Show("Please agree to the given terms and conditions");
                }
            }
            else
            {
